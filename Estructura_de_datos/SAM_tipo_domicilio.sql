...
CREATE TABLE `tipo_domicilio` (
  `id_tipo_domicilio` bigint(8) NOT NULL AUTO_INCREMENT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bi_tipo_domicilio BEFORE INSERT ON SAM.tipo_domicilio FOR EACH ROW 
                                                                                BEGIN 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bu_tipo_domicilio BEFORE UPDATE ON SAM.tipo_domicilio FOR EACH ROW
                                                                                BEGIN
