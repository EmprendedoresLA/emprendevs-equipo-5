...
CREATE TABLE `notificacion` (
  ...
  `id_inspeccion_comercio` bigint(20) DEFAULT NULL,
  `numero_notificacion` int(20) NOT NULL,
  `numero_partida` bigint(20) NOT NULL,
  `fecha_notificacion` date NOT NULL,
  `hora_notificacion` int(6) DEFAULT NULL,
  ...
  KEY `ak_kid_expediente_control` (`id_notificacion`),
  KEY `fk_reference_51` (`id_inspeccion_comercio`),
  CONSTRAINT `fk_reference_51` FOREIGN KEY (`id_inspeccion_comercio`) REFERENCES `inspeccion` (`id_inspeccion`)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bi_notificacion BEFORE INSERT ON SAM.notificacion FOR EACH ROW 
                                                                                BEGIN 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bu_notificacion BEFORE UPDATE ON SAM.notificacion FOR EACH ROW
                                                                                BEGIN
