...
--
-- Table structure for table `tipo_documento_expediente`
--

DROP TABLE IF EXISTS `tipo_documento_expediente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tipo_documento_expediente` (
  `id_tipo_documento_expediente` bigint(8) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_tipo_documento_expediente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tipo_documento_expediente`
--

LOCK TABLES `tipo_documento_expediente` WRITE;
/*!40000 ALTER TABLE `tipo_documento_expediente` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipo_documento_expediente` ENABLE KEYS */;
UNLOCK TABLES;
