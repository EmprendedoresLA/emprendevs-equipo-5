...
CREATE TABLE `zona` (
  `id_zona` int(8) NOT NULL AUTO_INCREMENT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bi_zona BEFORE INSERT ON SAM.zona FOR EACH ROW 
                                                                                BEGIN 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bu_zona BEFORE UPDATE ON SAM.zona FOR EACH ROW
                                                                                BEGIN
