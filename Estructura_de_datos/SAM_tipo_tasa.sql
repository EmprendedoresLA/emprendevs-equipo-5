...
CREATE TABLE `tipo_tasa` (
  `id_tipo_tasa` bigint(8) NOT NULL AUTO_INCREMENT,
  `id_numero_tasa` bigint(8) NOT NULL,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bi_tipo_tasa BEFORE INSERT ON SAM.tipo_tasa FOR EACH ROW 
                                                                                BEGIN 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bu_tipo_tasa BEFORE UPDATE ON SAM.tipo_tasa FOR EACH ROW
                                                                                BEGIN
