...
CREATE TABLE `calle` (
  `id_calle` int(8) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(90) NOT NULL,
  `numeracion_ini` int(5) NOT NULL DEFAULT '0',
  `numeracion_fin` int(5) NOT NULL DEFAULT '0',
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bi_calle BEFORE INSERT ON SAM.calle FOR EACH ROW 
                                                                                BEGIN 
