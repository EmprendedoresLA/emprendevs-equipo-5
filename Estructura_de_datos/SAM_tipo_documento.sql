...
CREATE TABLE `tipo_documento` (
  `id_documento_tipo` bigint(8) NOT NULL AUTO_INCREMENT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bi_tipo_documento BEFORE INSERT ON SAM.tipo_documento FOR EACH ROW 
                                                                                BEGIN 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bu_tipo_documento BEFORE UPDATE ON SAM.tipo_documento FOR EACH ROW
                                                                                BEGIN
