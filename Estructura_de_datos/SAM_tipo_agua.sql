...
CREATE TABLE `tipo_agua` (
  `id_tipo_agua` bigint(8) NOT NULL AUTO_INCREMENT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bi_tipo_agua BEFORE INSERT ON SAM.tipo_agua FOR EACH ROW 
                                                                                BEGIN 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER SAM.aud_bu_tipo_agua BEFORE UPDATE ON SAM.tipo_agua FOR EACH ROW
                                                                                BEGIN
